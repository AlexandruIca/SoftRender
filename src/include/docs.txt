...
/// platform(
/// [MacOS](https://github.com/AlexandruIca/SoftRender/releases/download/nightly/SoftRender-0.4-Darwin.tar.gz
/// ),
/// [Windows](https://github.com/AlexandruIca/SoftRender/releases/download/nightly/SoftRender-0.4-win64.zip
/// ), or
/// [Linux](https://github.com/AlexandruIca/SoftRender/releases/download/nightly/SoftRender-0.4-Linux.tar.gz
/// )).
